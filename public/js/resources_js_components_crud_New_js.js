(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_crud_New_js"],{
...
/***/ "./resources/js/components/crud/New.js":
/*!*********************************************!*\
  !*** ./resources/js/components/crud/New.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var New = /*#__PURE__*/function (_React$Component) {
  ...
  function New(props) {
    ...
    _this.state.dataForm.fbsetup = {
      ...
      controlOrder: ['text', 'textarea', 'number', 'select', 'date', 'autocomplete'],
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return _app_crud_Services__WEBPACK_IMPORTED_MODULE_2__["default"].save(data, this.state.moduleData);
              case 6:
                res = _context2.sent;
                if (res.success) {
                  redirect = '/crud/' + this.state.moduleData.name + '/list?message=created';
                  ;
