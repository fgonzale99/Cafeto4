(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_app_review_form_Questions_js"],{
...
/***/ "./resources/js/app/review/form/Questions.js":
/*!***************************************************!*\
  !*** ./resources/js/app/review/form/Questions.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_forms_FormReviewPage__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../components/forms/FormReviewPage */ "./resources/js/components/forms/FormReviewPage.js");
/* harmony import */ var _components_general_Button__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../components/general/Button */ "./resources/js/components/general/Button.js");
...
var New = /*#__PURE__*/function (_React$Component) {
  ...
  function New(props) {
    ...
    _this.state = {
      ...
      moduleData: {
        ...
        page: _this.props.match.params.page
      },
      dataForm: {
        action: '',
        method: 'POST',
    ...
    _this.state.dataForm.fbsetup = {
      ...
      controlOrder: ['header', 'paragraph', 'text', 'textarea', 'number', 'select', 'autocomplete'],
      inputSets: [{
        label: 'Grupo Predefinido',
        name: 'user-details',
        // optional - one will be generated from the label if name not supplied
        showHeader: true,
        // optional - Use the label as the header for this set of inputs
        icon: '📝',
        fields: [{
          type: 'header',
          subtype: 'h1',
  ...
  _createClass(New, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 7;
                return _review_Services__WEBPACK_IMPORTED_MODULE_4__["default"].pagesList(this.props.match.params.id);
              case 7:
                pagesList = _context.sent;
                if (pagesList.success == true) {
                  this.setState({
                    pages: Object.values(pagesList.pages)
                  });
                }
                this.setState({
                  moduleData: {
                ...
                _context.next = 12;
                return _review_Services__WEBPACK_IMPORTED_MODULE_4__["default"].getPage(this.state.moduleData);
              case 12:
                res = _context.sent;
                this.setState({
                  res: res
    ...
    key: "saveContinue",
    value: function () {
      var _saveContinue = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var form, data, res, nextPage, redirect;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 6;
                return _review_Services__WEBPACK_IMPORTED_MODULE_4__["default"].saveQuestions(data, this.state.moduleData);
              case 6:
                res = _context2.sent;
                if (res.success) {
                  nextPage = parseInt(res.idPage) + 1;
                  redirect = '/formreview/questions/' + this.state.moduleData.id + '/' + nextPage;
    ...
    key: "savePublish",
    value: function () {
      var _savePublish = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                res = _context3.sent;
                if (res.success) {
                  redirect = '/formreview/publish/' + this.state.moduleData.id;
                  window.location.href = redirect;
                } else {
                  alert(res.message);
                }
      ...
      function savePublish(_x2) {
        return _savePublish.apply(this, arguments);
      }
      return savePublish;
    }()
  }, {
    ...
    value: function render() {
      ...
      var form = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_forms_FormReviewPage__WEBPACK_IMPORTED_MODULE_10__["default"], {
      ...
      var card = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Card__WEBPACK_IMPORTED_MODULE_7__["default"], {
        data: data
      });
      var content = [];
      /*
      ...
      this.state.pages.map(function (item, i) {
        ...
        var step = {
          ...
          withLine: true,
          active: active,
          link: '/formreview/questions/' + _this2.state.moduleData.id + '/' + item.page
        };
        dataStepper.push(step);
      });
      var step = {
      ...
      dataStepper.push(step);
      var stepper = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Stepper__WEBPACK_IMPORTED_MODULE_9__["default"], {
        data: dataStepper
      });
      ...
      this.column = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Column__WEBPACK_IMPORTED_MODULE_5__["default"], {
        data: columnData
      });
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Row__WEBPACK_IMPORTED_MODULE_6__["default"], {
          content: this.column
        })
      });
    }
...
/***/ "./resources/js/components/forms/FormReviewPage.js":
/*!*********************************************************!*\
  !*** ./resources/js/components/forms/FormReviewPage.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _FormBuilder__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./FormBuilder */ "./resources/js/components/forms/FormBuilder.js");
...
var FormReviewPage = /*#__PURE__*/function (_React$Component) {
  _inherits(FormReviewPage, _React$Component);
  var _super = _createSuper(FormReviewPage);
  function FormReviewPage(props) {
    var _this;
    _classCallCheck(this, FormReviewPage);
    _this = _super.call(this, props);
    var formContent = [];
    _this.props.data.fields.map(function (item, i) {
      ...
      switch (item.type) {
        case 'text':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Input__WEBPACK_IMPORTED_MODULE_2__["default"], {
            data: item,
            value: value
          });
          break;
        case 'number':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Number__WEBPACK_IMPORTED_MODULE_3__["default"], {
            data: item,
            value: value
          });
          break;
        case 'date':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(Date, {
            data: item,
            value: value
          });
          break;
        case 'email':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Email__WEBPACK_IMPORTED_MODULE_4__["default"], {
            data: item,
            value: value
          });
          break;
        case 'password':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Password__WEBPACK_IMPORTED_MODULE_5__["default"], {
            data: item,
            value: value
          });
          break;
        case 'hidden':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Hidden__WEBPACK_IMPORTED_MODULE_7__["default"], {
            data: item,
            value: value
          });
          break;
        case 'file':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_File__WEBPACK_IMPORTED_MODULE_6__["default"], {
            data: item,
            value: value
          });
          break;
        case 'textarea':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Textarea__WEBPACK_IMPORTED_MODULE_8__["default"], {
            data: item,
            value: value
          });
          break;
        case 'areaeditor':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Areaeditor__WEBPACK_IMPORTED_MODULE_9__["default"], {
            data: item,
            value: value
          });
          break;
        case 'select':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Select__WEBPACK_IMPORTED_MODULE_10__["default"], {
            data: item,
            value: value
          });
          break;
        case 'radio':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Radio__WEBPACK_IMPORTED_MODULE_11__["default"], {
            data: item,
            value: value
          });
          break;
        case 'checkbox-group':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_Checkbox__WEBPACK_IMPORTED_MODULE_12__["default"], {
            data: item,
            value: value
          });
          break;
        case 'formbuilder':
          var inputContent = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_FormBuilder__WEBPACK_IMPORTED_MODULE_14__["default"], {
            data: item,
  ...
  _createClass(FormReviewPage, [{
    ...
    value: function render() {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("form", {
        ...
        children: [this.formContent, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_general_Button__WEBPACK_IMPORTED_MODULE_15__["default"], {
          onClick: this.props.actions.saveContinue,
          text: "Guardar y Agregar M\xF3dulo",
          className: "btn-info"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_general_Button__WEBPACK_IMPORTED_MODULE_15__["default"], {
          onClick: this.props.actions.saveFinish,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FormReviewPage);
