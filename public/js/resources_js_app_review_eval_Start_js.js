(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_app_review_eval_Start_js"],{
...
/***/ "./resources/js/app/review/eval/Start.js":
/*!***********************************************!*\
  !*** ./resources/js/app/review/eval/Start.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _crud_Services__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../crud/Services */ "./resources/js/app/crud/Services.js");
/* harmony import */ var _general_services_Module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../general/services/Module */ "./resources/js/app/general/services/Module.js");
...
/* harmony import */ var _components_general_Displaycolumns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../components/general/Displaycolumns */ "./resources/js/components/general/Displaycolumns.js");
...
/* harmony import */ var _components_general_Header__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/general/Header */ "./resources/js/components/general/Header.js");
...
/* harmony import */ var _components_forms_Form__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../components/forms/Form */ "./resources/js/components/forms/Form.js");
  ...
  function Start(props) {
    ...
    _this.state = {
      ...
      dataForm: {
        ...
        id: 'formAccept',
        formRef: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createRef(),
        fields: [],
        formValues: [],
        notDefaultButton: true
      }
    };
    _this.reviewDecline = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                yes = confirm("Confirme si desea rechazar la evaluación asignada.");
                if (!(yes === true)) {
                  _context.next = 6;
                  break;
                }
                _context.next = 4;
                return _review_Services__WEBPACK_IMPORTED_MODULE_3__["default"].reviewDecline(_this.state.moduleData.id);
              case 4:
                res = _context.sent;
                if (res.success) {
                  redirect = '/reviewer/projects?message=deleted';
    ...
    _this.Continue = /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        var pages, nextPage, redirect;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
  ...
  _createClass(Start, [{
    ...
    value: function () {
      var _componentDidMount = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var moduleData, _moduleData, res, infoModule, moduleProject, resProject, pagesList;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _crud_Services__WEBPACK_IMPORTED_MODULE_1__["default"].getModule(this.state.moduleData);
              case 3:
                ...
                this.setState({
                  ...
                  }, _defineProperty(_moduleData, "name", this.state.moduleData.name), _defineProperty(_moduleData, "id", this.props.match.params.id), _moduleData)
                });
                _context3.next = 8;
                return _review_Services__WEBPACK_IMPORTED_MODULE_3__["default"].getReviewInfo(this.state.moduleData.id);
              case 8:
                res = _context3.sent;
                infoModule = {
                  name: 'proyectos',
                ...
                _context3.next = 12;
                return _crud_Services__WEBPACK_IMPORTED_MODULE_1__["default"].getModule(infoModule);
              case 12:
                moduleProject = _context3.sent;
                _context3.next = 15;
                return _crud_Services__WEBPACK_IMPORTED_MODULE_1__["default"].get(infoModule);
              case 15:
                ...
                _context3.next = 19;
                return _review_Services__WEBPACK_IMPORTED_MODULE_3__["default"].pagesList(resProject.data.get_formreview.id);
              case 19:
                pagesList = _context3.sent;
                if (pagesList.success == true) {
                  this.setState({
                    pages: Object.values(pagesList.pages).filter(function (e) {
    ...
    value: function render() {
      ...
      var headerElement = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Header__WEBPACK_IMPORTED_MODULE_9__["default"], {
        data: headerContent
      });
      ...
      this.state.pages.map(function (item, i) {
        var active = '';
        if (item.page == _this2.state.moduleData.page) active = 'active';
        var step = {
          id: item.page,
          value: item.page,
          label: item.pageName,
          withLine: true,
          active: active,
          link: '/review/form/' + _this2.state.moduleData.id + '/' + item.page
        };
        dataStepper.push(step);
      });
      var step = {
      ...
      dataStepper.push(step);
      var stepper = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Stepper__WEBPACK_IMPORTED_MODULE_10__["default"], {
        data: dataStepper
      });
      content.push(stepper);
      contentCard.push( /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)("h3", {
        children: "Aceptar T\xE9rminos y Condiciones"
      }));
      var displayContent = {
        fields: this.state.reviewData.fields,
        data: this.state.reviewData.values
      };
      var display = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Displaycolumns__WEBPACK_IMPORTED_MODULE_7__["default"], {
      ...
      if (this.state.reviewData.values.state == 'Inactivo') {
        ...
        var form = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_forms_Form__WEBPACK_IMPORTED_MODULE_11__["default"], {
          data: this.state.dataForm,
          onSubmit: this.startReview.bind(this)
        });
        ...
        var submitButton = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
          ...
          onClick: this.startReview.bind(this)
        });
        footer.push(submitButton);
        var declineButton = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Button__WEBPACK_IMPORTED_MODULE_8__["default"], {
          text: "Rechazar",
          className: "btn-danger",
          align: "justify-content-center",
          onClick: this.reviewDecline.bind(this)
        });
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Row__WEBPACK_IMPORTED_MODULE_5__["default"], {
          content: header
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_components_general_Row__WEBPACK_IMPORTED_MODULE_5__["default"], {
          content: column
        })]
      });
    }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var _Label__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Label */ "./resources/js/components/forms/Label.js");
/* harmony import */ var react_signature_pad_wrapper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-signature-pad-wrapper */ "./node_modules/react-signature-pad-wrapper/dist/react-signature-pad-wrapper.es.js");
/* harmony import */ var _components_general_Button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/general/Button */ "./resources/js/components/general/Button.js");
  ...
  _createClass(Signature, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.Fragment, {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_Label__WEBPACK_IMPORTED_MODULE_1__["default"], {
          data: this.props.data
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(_components_general_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
          text: "Limpiar",
          className: "btn-danger",
...
/***/ "./resources/js/components/general/Displaycolumns.js":
/*!***********************************************************!*\
  !*** ./resources/js/components/general/Displaycolumns.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Displaycolumns = /*#__PURE__*/function (_React$Component) {
  _inherits(Displaycolumns, _React$Component);
  var _super = _createSuper(Displaycolumns);
  function Displaycolumns(props) {
    var _this;
    _classCallCheck(this, Displaycolumns);
    _this = _super.call(this, props);
    _this.state = {
      isLoading: true,
      error: '',
      newColumn: true,
      modalIsOpen: false,
      totalFields: _this.props.content.fields.length,
      columns: 2
    };
    _this.maxFields = Math.ceil(_this.state.totalFields / _this.state.columns);
    return _this;
  }
  _createClass(Displaycolumns, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
        ...
        children: this.props.content.fields.map(function (field, j) {
          var value = '';
          if (_this2.props.content.data[field.name]) value = _this2.props.content.data[field.name];
          if (field.origin == "model") {
            var alias = "get_" + field.name.toLowerCase();
            if (_this2.props.content.data[alias]) value = _this2.props.content.data[alias].name;
          }
          if (field.type == "file") {
            var file = _this2.props.content.data.files.filter(function (e) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Displaycolumns);
