...
const FormBuilder = function (opts, element, $) {
  ...
  const defaultFieldAttrs = type => {
    ...
    const typeAttrsMap = {
      ...
      text: defaultAttrs.concat(['subtype', 'minlength', 'maxlength']),
      date: defaultAttrs,
      ...
      textarea: defaultAttrs.concat(['subtype', 'minlength', 'maxlength', 'rows']),
    }
  ...
  const advFields = values => {
    ...
    const advFieldMap = {
      ...
      minlength: () => numberAttribute('minlength', values),
      access: () => {
