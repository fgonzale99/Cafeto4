(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_app_user_Edit_js"],{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 8;
                return _crud_Services__WEBPACK_IMPORTED_MODULE_2__["default"].getUserCurrent();
              case 8:
                res = _context.sent;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return _crud_Services__WEBPACK_IMPORTED_MODULE_2__["default"].userUpdate(data);
              case 5:
                res = _context2.sent;
                if (res.success) {
                  redirect = '/user/profile/documents';
                  window.location.href = redirect;
                } else {
                  alert('Se presento un inconveniente al actualizar los datos de usuario, en caso de hacer un cambio de correo es posible que ya este asociado a otro usuario.');
                }
              case 7:
              case "end":
                return _context2.stop();
