(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_app_process_Edit_js"],{
...
/***/ "./resources/js/app/process/Edit.js":
/*!******************************************!*\
  !*** ./resources/js/app/process/Edit.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  _createClass(Edit, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                res = _context2.sent;
                if (res.success) {
                  redirect = '/process/budget/' + this.state.moduleData.id;
    ...
    value: function render() {
      ...
      var dataStepper = [{
        ...
        withLine: false,
        active: '',
        link: '/process/budget/' + this.state.moduleData.id
      }];
