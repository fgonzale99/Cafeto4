        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <div class="btn-group">
                <a href="{{ route('process.new') }}" class="btn btn-info">Crear Proceso</a>
              </div>
            </div>
          </div>
          <div class="card-body">
            <table id="proyectosTable" class="table table-bordred table-striped">
             ...
             <tbody>
              ...
              <tr>
                ...
                <a class="btn btn-success btn-xs" href="{{ route('process.show') }}" ><span class="glyphicon glyphicon-pencil">Ver</span></a></td>
               </tr>
               @endforeach
               @else
               <tr>
